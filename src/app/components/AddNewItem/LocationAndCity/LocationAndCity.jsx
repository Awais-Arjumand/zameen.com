...
import { PiBuildingOfficeBold, PiFarm, PiBuildingsBold } from "react-icons/pi";
...
const ChipsData = {
  ...
  Plots: [
    ...
    { icon: <FaRegFileAlt />, label: "Plot File" },
    { icon: <FaRegFileAlt />, label: "Plot Form" },
  ],
  Commercial: [
        ...
        <div className="w-fit h-fit flex flex-col gap-y-3">
          <div className="w-full h-fit flex flex-col gap-y-3 py-3">
            <SelectionIconOrLabel
              icon={<CiCircleCheck className="text-xl text-gray-700" />}
          ...
          <div className="w-full h-fit flex flex-col gap-y-3 py-3">
            <SelectionIconOrLabel
              icon={<BiBuildingHouse className="text-xl text-gray-700" />}
          ...
          <div className="w-full h-fit flex flex-col gap-y-3 py-3">
            <SelectionIconOrLabel
              icon={<CiLocationOn className="text-xl text-gray-700" />}
              label={"Type City"}
            />
            <input
              type="text"
              ...
              className="border border-gray-500 capitalize rounded px-3 py-2 outline-1 outline-green-500 placeholder:text-sm text-sm"
              placeholder="Type City"
            />
          </div>
          <div className="w-full h-fit flex flex-col gap-y-3 py-3">
            <SelectionIconOrLabel
              icon={<FaMapLocation className="text-xl text-gray-700" />}
              label={"Type Location"}
            />
            <input
              type="text"
              ...
              className="border border-gray-500 rounded capitalize px-3 py-2 outline-1 outline-green-500 placeholder:text-sm text-sm"
